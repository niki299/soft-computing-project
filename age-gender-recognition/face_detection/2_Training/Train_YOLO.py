...
keras_yolo3_path = os.path.join(get_parent_dir(1), "2_Training\\src\\keras_yolo3\\yolo3\\model.py")
sys.path.append(keras_yolo3_path)
...
if __name__ == "__main__":
    ...
    if _has_wandb:
        wandb.init(
            project="face_detection", config=vars(FLAGS), sync_tensorboard=False
        )
